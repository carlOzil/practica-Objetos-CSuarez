...
//4.- Crea un objeto de nombre Perro que tenga las propiedades: nombre, raza, color, edad, función ladrar (imprime po
let Perro = {
    nombre: '',
    raza: '',
    color: '',
...
let nivelesTinta = Impresora.tinta = { rojo: '', verde: '', azul: '' }
